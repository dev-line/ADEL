    ...
    verify(Cookies, "ORDERS", async (err, decoded: any) => {
      if (!err && decoded) {
        ...
        const IsInCart = data.findIndex(
          (itm) => itm.id == Order.id && itm.type == Type.current?.value
        );
        if (IsInCart >= 0) {
          const NewList = data.map((itm) => {
            if (itm.id == Order.id && itm.type == Type.current?.value) {
              itm.qn! += QN;
              itm.total! =
                (Type.current?.value == "SILVER"
                  ? itm.price_silver
          ...
          var NewItem = Order;
          NewItem.type = Type.current?.value!;
          NewItem.qn = QN;
          NewItem.total =
            (Type.current?.value == "SILVER"
              ? NewItem.price_silver
              : NewItem.price_blacquer) * QN;
  ...
  return (
    ...
    {products.length>0?(
            ...
            <div className="container">
              <div className="text-center">
                <h6 className="mb-2 text-muted-f">منتجاتنا</h6>
                <h2 className="mb-5 mb-lg-10">اكتشف المنتجات المميزة</h2>
              </div>
    ...
    <div className="row">{MostProduct()}</div>
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="my-auto">
                        <button
                          ...
                          type="button"
                          className="btn btn-xs btn-white swiper-next shadow-soft ml-2"
                        >
                        ...
                        <button
                          ...
                          type="button"
                          className="btn btn-xs btn-white swiper-prev shadow-soft"
                        >
          ...
          <div className="row">
            <div className="col-4">
              <div className="media d-block d-lg-flex text-center text-lg-right">
                ...
                <div className="media-body mr-3">
                  <h6 className="mb-0">توصيل مجاني</h6>
                  <p className="small mb-0 d-none d-lg-block">
                    توصيل مجاني وسريع لجميع ولايات الوطن.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-4" id="stb">
              <div className="media d-block d-lg-flex text-center text-lg-right">
                ...
                <div className="media-body mr-3">
                  <h6 className="mb-0">جودة مضمونة</h6>
                  <p className="small mb-0 d-none d-lg-block">
                    منتجات ذات جودة عالية ومضمونة.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-4">
              <div className="media d-block d-lg-flex text-center text-lg-right">
                ...
                <div className="media-body mr-3">
                  <h6 className="mb-0">دعم فني</h6>
                  <p className="small mb-0 d-none d-lg-block">
                    دعم فني على مدار الأسبوع 7/7.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="container space-2 text-center">
        ...
        <p className="font-size-1 mb-1">© 2020. جميع الحقوق محفوظة.</p>
        <p className="font-size-1" dir="ltr">
          Made with<i className="fas fa-heart text-danger-f mx-2"></i>&amp;
          <i className="fas fa-coffee text-dark opacity-80 mx-2"></i>By{" "}
          <a href="https://linktr.ee/hax.codes" target="_blank">
            Hax Codes™
          </a>
        </p>
                ...
                <div className="card-body">
                  ...
                  <div className="small mb-2">
                    ...
                    >
                      ...
                      <option value="PLACQUER">بلاكيور</option>
                    </select>
                  </div>
