    ...
    <React.Fragment>
      ...
      <div className="cover">
        <div className="container text-center">
            ...
            <h2 className=" font-weight-bolder">لقد تم اعادة تعيين كلمة المرور الخاص بك</h2>
<Link href="/dashboard/admin/login">
<a className="btn btn-sm btn-success-f font-weight-semi-bold text-white px-5">الذهاب الى صفحة تسجيل الدخول</a>
